...
class ThirdTab extends GetView<FrameController> {
            ...
            () => Padding(
              ...
              child: Row(
                children: List.generate(
                  controller.options_tab_3.length,
  ...
  Widget _buildImageOption(int index) {
    return Obx(
      () => GestureDetector(
        onTap: () => controller.setSelectedIndex_tab_3(index),
        child: Container(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: controller.selectedIndex_tab_3.value == index
                        ? Colors.purple
              ...
              Text(
                controller.options_tab_3[index],
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: controller.selectedIndex_tab_3.value == index
                      ? FontWeight.bold
                      : FontWeight.normal,
                  color: controller.selectedIndex_tab_3.value == index
                      ? Colors.purple
